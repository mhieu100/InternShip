    ...
    const mockReviews = [
      {
        ...
        comment:
          'This product exceeded my expectations. The quality is outstanding and delivery was super fast. Highly recommend to anyone looking for this type of product.',
        date: '2024-01-15',
        helpful: 12,
        images: [
      ...
      },
      {
        ...
        comment:
          'Pretty good product overall. Works as expected and the price is reasonable. Only minor issue is the packaging could be better.',
        date: '2024-01-10',
        helpful: 8,
        images: [],
        verified: true,
      ...
      },
      {
        ...
        title: 'Perfect!',
        comment:
          'Exactly what I was looking for. Great quality, fast shipping, and excellent customer service. Will definitely buy again!',
        date: '2024-01-08',
        helpful: 15,
        images: [
    ...
    <div className="max-w-7xl mx-auto p-6 min-h-screen">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <InputNumber
                    ...
                    size="large"
                  />
                  <Text type="secondary">{product.stock || 10} available</Text>
                </div>
      ...
      >
        <div className="py-4">
          ...
          >
            {/* Rating */}
            <Form.Item label="Your Rating" required className="mb-6">
            ...
            {/* Image Upload */}
            <Form.Item label="Add Photos (Optional)" className="mb-6">
              <Upload
            ...
            <div className="bg-blue-50 p-4 rounded-lg mb-6">
              ...
              <ul className="text-sm text-blue-700 space-y-1 mb-0 ml-4">
                ...
                <li>
                  Include specific details about quality, fit, or performance
                </li>
              </ul>
            </div>
